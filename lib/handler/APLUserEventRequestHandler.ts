...
export abstract class APLUserEventRequestHandler implements RequestHandler {
    ...
    public canHandle(handlerInput : HandlerInput) : Promise<boolean> | boolean {
        return HandlerChecks.isAPLUserEventWithArguments(handlerInput.requestEnvelope, ...this.args);
    }
